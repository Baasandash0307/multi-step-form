export const Continue = ({ nextStep, currentStep, prevStep }) => {
    return (
        <div className="flex w-[416px] h-[44px] gap-2 justify-center mt-[100px] mb-5">
            {
                currentStep != 1 && <button type="button" className="bg-white text-black h-[44px] w-[128px] rounded-[8px] font-bold border-[2px]" onClick={prevStep} >Back</button>
            }
