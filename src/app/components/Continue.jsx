export const Continue = ({ nextStep, previousStep, currentStep}) => {
    return (
        <div className="flex w-[416px] h-[44px] gap-2 justify-center">
            {
                currentStep != 1 && <button className="bg-white text-black h-[44px] w-[128px] rounded-[8px] font-bold border-[2px]" onClick={previousStep} type="button">Back</button>
            }
